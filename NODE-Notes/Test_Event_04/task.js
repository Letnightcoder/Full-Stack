Kallol//? Challenge: "Event Maestro: Handle It All!"
...
// Emit some events
emitter.emit("user-login", "Kallol");
emitter.emit("user-purchase", "Kallol", "Laptop");
// emitter.emit("profile-update", "Kallol", "email");
// emitter.emit("user-logout", "Kallol");
